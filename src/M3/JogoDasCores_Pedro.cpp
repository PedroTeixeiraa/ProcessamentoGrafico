...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Jogo das cores! Pedro Teixeira Alves", nullptr, nullptr);
  ...
  for (int i = 0; i < ROWS; i++)
	...
	cout << "Jogo finalizado! Pontuacao total: " << pontuacaoTotal << endl;
...
void eliminarSimilares(float tolerancia)
{
	...
	if (eliminados > 0)
	{
		int pontos = (eliminados * 10) - (tentativas * 2);
		if (pontos < 0) pontos = 0;
		pontuacaoTotal += pontos;
		cout << "Tentativa #" << tentativas << " - Eliminados: " << eliminados
			 << " - Pontos ganhos: " << pontos
			 << " - Pontuacao total: " << pontuacaoTotal << endl;
	}
	else
	{
		cout << "Tentativa #" << tentativas << " - Nenhum eliminado. Pontos ganhos: 0" << endl;
	}
