...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Ola Triangulo! -- Pedro", nullptr, nullptr);
	...
	VAOs.push_back(createTriangle(0.4, 0.6, 0.7, 0.8, 0.6, 0.4));
	VAOs.push_back(createTriangle(-0.2, -0.5, 0.2, -0.5, 0.0, -0.1));
	VAOs.push_back(createTriangle(-0.8, -0.6, -0.6, -0.9, -0.4, -0.6));
	VAOs.push_back(createTriangle(0.5, 0.0, 0.8, 0.2, 0.6, -0.2));
